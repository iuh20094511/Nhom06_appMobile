...
//     try {
//         await axios.post('http://192.168.134.1:5000/user/:id', id).then((response)=> {
...
//     try {
//         await axios.post('http://192.168.134.1:5000/user/:id').then((response)=> {
//             console.log(response.data); // Log the response from the server
//         })
//     } catch (error) {
//         if (axios.isAxiosError(error)) {
...
//   const id = req.params.id;
//   try {
//       await axios.post('http://192.168.134.1:5000/user/:id/follow', id).then((response)=> {
//           console.log(response.data); // Log the response from the server
//       })
//   } catch (error) {
//       if (axios.isAxiosError(error)) {
...
//   const id = req.params.id;
//   try {
//       await axios.post('http://192.168.134.1:5000/user/:id/unfollow', id).then((response)=> {
//           console.log(response.data); // Log the response from the server
//       })
//   } catch (error) {
//       if (axios.isAxiosError(error)) {
...
//   try {
//       await axios.post('http://192.168.134.1:5000/user/:id', userId).then((response)=> {
//           console.log(response.data); // Log the response from the server
//       })
//   } catch (error) {
//       if (axios.isAxiosError(error)) {
