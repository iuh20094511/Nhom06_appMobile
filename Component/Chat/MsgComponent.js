...
import TimeDelivery from '../Chat/TimeDelivery';
...
const MsgComponent = (props) => {
    ...
    return ( <Pressable style = {
        ...
        <Text style = {
            { paddingLeft: 5, color: sender ? COLORS.white : COLORS.black, fontFamily: FONTS.Regular, fontSize: 12.5 }
        } > { item.message } 
        </Text>

        <
        TimeDelivery sender = { sender }
        item = { item }/> 
        </View > 
        </Pressable>
    );
